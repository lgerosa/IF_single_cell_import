...
Data=load_average_data([RawDataFolder 'Hoechst_WCB_647_HT29[7974593].result.1'],FilterHeader);

%% add single cell data to average data
FilterHeaderSSC={}; %specifiy which header you want, if empty is all 
Data=add_singlecell_data(RawDataFolder,'Hoechst_WCB_647_HT29[7974593].result.',Data,genWellNames(2:7,2:11),FilterHeaderSSC);

%% add design to data
%load designs from excell and add it to the data
Design = plate_layout_excell_importer([PlateLayoutFolder 'PlateLayout_20180320_P1.xlsx']);
